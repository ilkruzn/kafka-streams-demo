...
public class Producers {
  ...
  static final String TOPIC_PLAY_EVENTS = "play-events";
  static final String TOPIC_SONG_FEED = "song-feed";
  ...
  public static void main(String... args) throws Exception {
    ...
    template1.setDefaultTopic(TOPIC_SONG_FEED);
    ...
    DefaultKafkaProducerFactory<String, PlayEvent> pf2 = new DefaultKafkaProducerFactory<>(props);
    KafkaTemplate<String, PlayEvent> template = new KafkaTemplate<>(pf2, true);
    template.setDefaultTopic(TOPIC_PLAY_EVENTS);
